...
export const DISABLE_METADATA_ID = `${EXTENSION_ID}/disable`;
export const ASK_FOR_CONFIRMATION_METADATA_ID = `${EXTENSION_ID}/ask`;
export const SPREAD_RELATIVE = "relative";
